...
library.ConfigSystem = function(self, name)
	if not isfolder("!DragonZ") then
		makefolder("!DragonZ");
	end
	local configSystem = {};
	configSystem.configFolder = "!DragonZ/" .. tostring(game.Players.LocalPlayer.Name) .. "";
...
if not game:GetService("CoreGui"):FindFirstChild("wewewewewewewweweweweweweweweweeweweweweloveyousomuch") then
	local function RainbowText(text)
		spawn(function()
			local add = 10;
			wait(0.1);
	...
	spawn(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/DevSoGod/MyScript/main/Notification"))()
		wait()
		Notification(1, "Executed!", "", 10)
	end);
	...
	GuiStat.Name = "wewewewewewewweweweweweweweweweeweweweweloveyousomuch";
	...
	game:GetService("RunService").Heartbeat:Connect(function()
        ...
        if ((currentTime - startTime) >= 1) then
            ...
            if (fps ~= oldfps) then
                ...
                labels.Frame["1FPSCount"].IconButton.IconLabel.Text = "FPS " .. fps;
